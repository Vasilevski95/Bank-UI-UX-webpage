...
const Stats = () => {
  return (
    <section className={`${styles.flexCenter} flex-row flex-wrap sm:mb-20 mb-6`}>
      {stats.map((stat) => (
        //We map over stats, that is stat.map, we get each individual stat, and then we wanna instantly return something from each stat
        //And that something is a div, that div is going to have a key and a className
